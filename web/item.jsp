...
<% 
	...
	Product item = (Product) application.getAttribute("ITEM");
%>
    ...
    <div class="wrapper_container">
        ...
        <div class="product_view">
            <div class="image_container">
                <img class="product_image" src="./assets/item_images/<%= item.getImagePath() %>" alt="<%= item.getImagePath() %>">
            </div>
            <div class="product_details">
                ...
                <form action="Add" method="post">
                    ...
                    <!-- HIDDEN FIELDS ------------------------------------------------------------------------- -->
                    <input type="hidden" name="item_image" 	value="<%= item.getImagePath() %>	">
                    <input type="hidden" name="item_stocks" value="<%=item.getStocks()%>		">
                    ...
                    <input class="quantity_field" type="number" min="1" max="<%= item.getStocks() %>" name="quantity" required="required" value="1">
                    <br>
